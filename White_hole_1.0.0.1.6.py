                ...
                for byte in sda:
                    ...
                    while eo<sdad:
                        ...
                        while sw<20000:
                            ...
                            numbertc3=numbertc%((2**32-1)-(2**24-1))
                            eew1=0
                           
                            numbertc4=numbertc3+(2**24-1)
                            
                            
                            
                            numbertc1=numbertc//((2**32-1)-(2**24-1))
